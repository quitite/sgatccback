...
{
    public abstract class SGAWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SGAWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SGAWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SGADbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SGADbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SGADbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SGADbContext, Task<T>> func)
        {
            T result;
