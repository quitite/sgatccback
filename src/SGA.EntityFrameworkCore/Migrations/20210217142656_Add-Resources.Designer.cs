...
namespace SGA.Migrations
{
    ...
    [Migration("20210217142656_Add-Resources")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGA.Resources.Resource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("SGA.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("SGA.Authorization.Users.User", null)
                        .WithMany("Claims")
